...
<label for="from">To</label><input id="to"><button id="btLoad">Show</button><br />
<button id="btLastWeek">Last Week</button><button id="btLastMonth">Last Month</button><button id="btLastYear">Last Year</button><br />
